  ...
  return (
    <>
      ...
      >
        <div className="mr-3">
          <motion.svg
            viewBox="8.634 5.58835026 62.64 44.32264974"
            width="62.64"
            whileTap={{
              scale: 0.7,
              x: -10,
          ...
          >
            ...
            />
            <path
              d="m19.846 5.59a2.253 2.245 0 0 0 -2.25 2.246 2.253 2.245 0 0 0 2.254 2.243 2.253 2.245 0 0 0 2.252-2.245v-.004a2.253 2.245 0 0 0 -2.256-2.241zm40.302 0a2.253 2.245 0 0 0 -2.25 2.246 2.253 2.245 0 0 0 2.255 2.243 2.253 2.245 0 0 0 2.252-2.245v-.004a2.253 2.245 0 0 0 -2.257-2.241z"
              fill="#c73148"
            />
            <path
              d="m19.757 7.525c-.783.042-.744 1.18-.744 1.18 4.209 8.196 11.957 12.215 20.893 12.216 8.924-.013 16.749-4.077 20.952-12.261 0 0 .166-1.541-1.474-1.007-4.31 7.144-11.55 11.37-19.473 11.383-7.937.002-15.152-4.18-19.47-11.337-.28-.135-.503-.184-.684-.174zm28.48 31.854-2.394 7.13-2.33-7.125h-2.275l3.672 10.366h1.771l2.4-6.809 2.396 6.809h1.786l3.665-10.365h-2.218l-2.335 7.125-2.394-7.13zm-12.716.003-4.645 10.361h2.183l.897-2.006.064-.151h4.826l.946 2.157h2.243l-4.603-10.3-.04-.061zm33.642 0v10.355h2.111v-10.354zm-60.529.002v10.369h2.14v-4.211h4.83v4.21h2.141v-10.367h-2.14v4.183h-4.83v-4.183zm19.014.003v5.935c0 1.685-.85 2.585-2.397 2.585-1.554 0-2.41-.925-2.41-2.657v-5.857h-2.141v5.929c0 2.917 1.65 4.589 4.523 4.589 2.9 0 4.563-1.704 4.563-4.675v-5.85zm31.006.004v10.354h7.963v-1.888h-5.853v-2.567h3.891v-1.89h-3.891v-2.12h5.65v-1.888zm-22.227 2.614 1.526 3.472.104.239h-3.237l.102-.239z"
              fill="#fff"
              stroke-width="1.079"
            />
          </motion.svg>
        ...
        <div>
          ...
          <div className="text-xl font-semibold font-sans -mt-1">
            <a href={details.huaweiDownload.href} target="_blank">
              {details.huaweiDownload.text}
            </a>
          </div>
        </div>
      </motion.button>
...
export default HuaweiGalleryButton;
