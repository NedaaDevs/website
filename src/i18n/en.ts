export default {
  ...
  'ledger.availability': 'Availability',
  'ledger.responseTime': 'Response time',
  'ledger.percentiles': 'p50 / p95',
  'ledger.modules': 'Traffic by module',
  'ledger.topReciters': 'Most listened reciters',
  'ledger.reciter': 'Reciter',
  'ledger.plays': 'Plays',
  'ledger.module': 'Module',
  'ledger.share': 'Share',
  'ledger.percent': '%',
  'ledger.requests': 'Requests',
  'ledger.lifetime': 'Requests, all time',
  'ledger.reciters': 'Reciters',
