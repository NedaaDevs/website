  ...
  "@graph": [
    {
      ...
      "featureList": [
        ...
        "Text mode rendering the Tanzil Uthmani text with no download required",
        ...
        "Sleep timer, and continue / repeat / stop at end of surah",
        "Per-surah and per-reciter audio download for offline listening",
        "Native media controls (lock screen, Bluetooth/AirPods) and background playback",
