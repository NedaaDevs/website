...
أكثر تطبيقات مواقيت الصلاة تُعلن عن "منبّه فجر". وأكثر هذه المنبّهات **إشعاراتٌ في ثوب منبّه**، تفشل في إيقاظك تقريبًا بقدر ما تنجح، خصوصًا حين يكون الهاتف صامتًا ليلًا أو في وضع "عدم الإزعاج". هذه الصفحة توثّق:
...
لا تتضمّن هذه الصفحة (حتى الآن) نتائج مقارنة مع تطبيقاتٍ أخرى، لأنّ هذا الاختبار يستغرق ٣٠ يومًا من القياس لكلّ جهاز. المنهجيّة جاهزة للنشر الآن، والنتائج تأتي حين يُجرى القياس.
...
2. **Critical Alerts تتطلّب موافقة آبل**، ولا تمنحها آبل إلّا لعددٍ قليل من التطبيقات. التطبيقات التي تريد تجاوز عدم الإزعاج دون AlarmKit تحتاج هذه الصلاحية.
...
- لا يقيّم **دقّة المواقيت**، وهي مسألةٌ منفصلة تتناولها [صفحة المواقيت](/ar/docs/prayer-times).
